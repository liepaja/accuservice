  ...
  return (
    <Layout>
      ...
      <div className="flex-container">
        ...
        <a  href="/vanmoof" ><img style={{marginBottom:0,border:"black", borderWidth:"5px", borderStyle:"solid", padding:"15px"}} src="https://res.cloudinary.com/dge6vq2wh/image/upload/v1709509050/AccuService/Vanmoff_errors_s3.png"  /> </a>       
        </div>
      </div>
